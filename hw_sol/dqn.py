...
def build_dqn(lr, n_actions, input_dims, layer1_dims, layer2_dims, layer3_dims):
    model = keras.Sequential([
        keras.layers.Conv2D(layer1_dims,3, activation='relu'),
        keras.layers.Conv2D(layer2_dims,3, activation='relu'),
        keras.layers.Conv2D(layer3_dims,3, activation='relu'),
...
class Agent():
    ...
    def __init__(self, lr, gamma, n_actions, epsilon, batch_size,
        ...
        self.q_eval = build_dqn(lr, n_actions, input_dims,8,16,32) 
